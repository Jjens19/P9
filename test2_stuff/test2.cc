...
int main(int argc, char *argv[])
{
    ...
    do
    {
        ...
        // Print average RTT
        std::cout << g_packetCount << "," << g_ackReceived << "," << g_bytesSent << "," << averageRtt << Simulator::Now() << "," << std::endl;
	...
	count++;
    } while (g_packetCount > 0 || g_ackReceived > 0 || g_bytesSent > 0 || count < 400); //400
